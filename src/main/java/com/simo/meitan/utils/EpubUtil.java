...
public class EpubUtil {
    ...
    public static Book getEupbBook(String filePath){
        String fileAbsolutePath =FileUtil.getfileAbsolutePath(filePath);
    ...
    public static void parse(String fileAbsolutePath){
        File file = new File(fileAbsolutePath);
        InputStream in = null;
        try {
            //从输入流当中读取epub格式文件
